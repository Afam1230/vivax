      ...
      >
        ...
        >
          ...
          <VStack spacing={4}>
            ...
            >
              {showLocationFields ? 'Hide Location Details' : 'Add Location Details'}
            </Button>
            <Collapse in={showLocationFields} animateOpacity style={{ width: '100%' }}>
            <FormControl>
            ...
            <FormControl isDisabled={!selectedCountry}>
            ...
            <FormControl isDisabled={!selectedState}>
              ...
              >
                {City.getCitiesOfState(selectedCountry, selectedState).map((city, idx) => (
