import { Box, Image, Text, VStack, HStack, Input, Button } from "@chakra-ui/react";
  ...
  return (
    <Box bg="#FFF7E6" p={10} textAlign="center" borderRadius="xl" maxW={'100vh'}>
      ...
      <HStack mt={5} justify="center">
        <a href="https://google.com"><Button  colorScheme="orange" borderRadius="full" _hover={{ bg: "brown.700" }}>Subscribe Now</Button></a> 
      </HStack>
    </Box>
  );
};
